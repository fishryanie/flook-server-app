  ...
  Register: async (req, res) => {
    ...
    try {
      ...
      if(sendMail && register){
         res.status(200).send({data:register, success: true, message: 'Sign up successfully, check your mail to get password'});
      }
      if(!sendMail || !register){
         res.status(400).send({ success: true, message: 'Sign up successfully, check your mail to get password'});
      }
