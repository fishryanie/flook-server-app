...
module.exports = app => { 
  ...
  app.put(apiString.updateOneAuthor, upload.single("image"), middlewares.auth.accessPermission(subStr(apiString.updateOneAuthor)) , Controller.author.updateOneAuthor);
