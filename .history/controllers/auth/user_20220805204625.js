  ...
  Register: async (req, res) => {
    ...
    try {
      ...
      if(sendMail && register){
         res.send({data:register, success: true, message: 'Sign up successfully, check your mail to get password'});
      }
      if(!sendMail || !register){
         res.send({ success: false, message: 'Sign up not successfully'});
      }
